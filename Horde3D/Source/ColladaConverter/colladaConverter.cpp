...
SceneNode * ColladaConverter::createSceneNode( AvailableSceneNodeTypes type )
{
	switch ( type )
	{
...
bool ColladaConverter::convertModel( bool optimize )
{
...
Matrix4f ColladaConverter::getNodeTransform( DaeNode &node, unsigned int frame )
{
...
bool ColladaConverter::writeGeometry( const string &assetPath, const string &assetName ) const
{
...
void ColladaConverter::writeSGNode( const string &assetPath, const string &modelName, SceneNode *node, unsigned int depth, ofstream &outf ) const
{
...
bool ColladaConverter::writeSceneGraph( const string &assetPath, const string &assetName, const string &modelName ) const
{
	ofstream outf;
...
bool ColladaConverter::writeModel( const std::string &assetPath, const std::string &assetName, const std::string &modelName ) const
{
	bool result = true;
...
bool ColladaConverter::writeMaterials( const string &assetPath, const string &modelName, bool replace ) const
{
...
bool ColladaConverter::hasAnimation() const
{
	return _frameCount > 0;
}


void ColladaConverter::writeAnimFrames( SceneNode &node, FILE *f ) const
{
...
bool ColladaConverter::writeAnimation( const string &assetPath, const string &assetName ) const
{
